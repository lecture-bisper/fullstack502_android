...
import btic.fullstack502.app_20250805.databinding.ActivityReceiverBinding
...
//        현재 배터리 상태가 충전 중인지 확인
        BatteryManager.BATTERY_STATUS_CHARGING -> {
//          충전 중일 경우 어떤 방식으로 충전 중인지 정보 가져오기
          when (getIntExtra(BatteryManager.EXTRA_PLUGGED, -1)) {
//            배터리 충전 방식이 USB 인지 AC 전원 인지 확인
