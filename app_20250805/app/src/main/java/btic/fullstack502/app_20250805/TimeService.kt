...
//  onBind() 는 Service 컴포넌트를 상속받아 사용 시 무조건 구현해야 함
  override fun onBind(intent: Intent): IBinder {
    Log.d("**fullstack502**", "### startService() 실행 - onBind() 호출 ###")
...
//  Service 컴포넌트의 생명주기 함수 중 객체 생성 시 1번만 실행됨
  override fun onCreate() {
    ...
    Log.d("**fullstack502**", "### startService() 실행 - onCreate() 호출 ###")
  }

//  startService() 실행 시 매번 실행되는 생명주기 함수
  override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
    Log.d("**fullstack502**", "### startService() 실행 - onStartCommand() 호출 ###")
...
//  stopService() 실행 시 실행되는 함수, 서비스 종료
  override fun onDestroy() {
    ...
    Log.d("**fullstack502**", "### stopService() 실행 - onDestroy() 호출 ###")
  }
}